...
int main(int argc, char **argv){
    ...
    //======CHECK IF IATA_FAA IS ENTERED========///
  	if( argc!=2 ){
    	fprintf(stderr, "Usage: %s <IATA_FAA VALUE> \n", argv[0]);
    	return(1);
  	}
	...
	//=====QUERY TO GET COMMERCIAL FLIGHTS THAT CAN'T REACH <INSERT AIRPORT>=====//
  	char sql_stmt[2048]; 
	sprintf(sql_stmt, 
